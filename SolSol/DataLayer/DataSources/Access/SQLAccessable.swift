...
public protocol SQLAccessable: SQLAccessAdapterable {
    ...
    func fetchOne<T: PersistableRecord & FetchableRecord>(type: T.Type, query: QueryInterfaceRequest<T>) async -> T?
    func fetchAll<T: PersistableRecord & FetchableRecord>(type: T.Type, rawQuery: String) async -> [T]?
    func fetchAll<T: PersistableRecord & FetchableRecord>(type: T.Type, query: QueryInterfaceRequest<T>) async -> [T]?

...
public enum ModuleDependency {
    ...
    var targetDependency: TargetDependency {
        switch self {
        case .core:
            return .project(target: "SolSolCore", path: .relativeToRoot("Projects/Core"))
        case .designSystem:
            return .project(target: "DesignSystem", path: .relativeToRoot("Projects/DesignSystem"))
        case .domain:
            return .project(target: "Domain", path: .relativeToRoot("Projects/Domain"))
        case .data:
            return .project(target: "Data", path: .relativeToRoot("Projects/Data"))
        case .homePresentation:
            return .project(target: "HomePresentation", path: .relativeToRoot("Projects/Presentation/Home"))
        case .transactionPresentation:
            return .project(target: "TransactionPresentation", path: .relativeToRoot("Projects/Presentation/Transaction"))
        case .factory:
...
public enum ExternalPackages {
    public static let all: [Package] = [
        .remote(url: "https://github.com/hmlongco/Factory.git", requirement: .upToNextMajor(from: "2.5.3")),

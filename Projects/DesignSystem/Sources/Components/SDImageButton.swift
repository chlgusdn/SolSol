...
public final class SDImageButton: UIButton, DampingAnimation {
    ...
    private var highlightColor: UIColor = SDColors.white70 ?? .white

    private var buttonBackgroundColor: UIColor = SDColors.white100 ?? .white
    ...
    @discardableResult
    public func setSubTitle(text: String) -> Self {
        var config = configuration ?? UIButton.Configuration.plain()
